                            ...
                            <form method="post" action="add_meal" class="form-horizontal">
                                ...
                                <label>
                                    <select class="custom-select" name="mealTime" required>
                                        <option ${mealTime=="breakfast"?"selected":""} value="breakfast"><fmt:message
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroup-sizing-default"><fmt:message key="product.quantity"/></span>
                                    </div>
                                    <input type="number" min="1" name="quantity" value="${quantity}" maxlength="10"
